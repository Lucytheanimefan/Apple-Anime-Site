...
app = Flask(__name__)
#app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://appuser:LLHzvFRXTGJTXJNZPOGBzfIk@orchard-ambassador:59614/appdb'#'postgresql://localhost/lucyzhang'#tkatzenbaer'
db.init_app(app)
